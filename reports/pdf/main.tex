...
\usetikzlibrary{shadows, shapes, arrows, positioning, fit, calc}
\usetikzlibrary{calc}
...
\large
\input{content/1. GIỚI THIỆU TỔNG QUAN}
\input{content/2. TIỀN XỬ LÝ DỮ LIỆU}
\input{content/3. MÔ HÌNH HÓA CƠ SỞ - KỸ THUẬT TRONG ĐỀ CƯƠNG}
\input{content/4. MÔ HÌNH HÓA NÂNG CAO}
\input{content/5. SO SÁNH, TRỰC QUAN HÓA VÀ KHAI PHÁ TRI THỨC}
\input{content/6. RA QUYẾT ĐỊNH VÀ KẾT LUẬN}
\input{content/7. References}
